/*
  ...
  - You are about to drop the column `is` on the `gyms` table. All the data in the column will be lost.
  ...
  - The required column `id` was added to the `gyms` table with a prisma-level default value. This is not possible if the table is not empty. Please add this column as optional, then populate it before making it required.
